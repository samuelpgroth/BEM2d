...
lambda=2*pi;%/real(k0);                    % compute wavelength in the exterior
lambda_star = c_star;%/real(k0);            % distance from corner over which mesh is graded.
